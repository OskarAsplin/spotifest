    ...
    <div className={classes.background}>
      <MuiThemeProvider theme={muiTheme}>
        ...
        <div className={classes.root1}>
          <Box className={classes.box2}>
            <Button
              className={clsx(
                classes.button,
                bigScreen ? classes.buttonSizeBig : classes.buttonSizeSmall
              )}
            ...
            >
              <img
                src={
                  process.env.PUBLIC_URL + '/techIcons/Spotify-Mark-white.png'
                }
                className={
                  bigScreen ? classes.spotifyIconBig : classes.spotifyIconSmall
                }
                alt="Spotify-icon"
              />
        ...
        <Box className={clsx(classes.footerBox, classes.attributionShadow)}>
          <Typography
            variant={bigScreen ? 'body1' : 'body2'}
            color={'secondary'}
            className={classes.footerFontSize}
          >
