  ...
  const handleSearchBlur = (num: number, isBlur: boolean) => {
    ...
    if (
      ...
      (searchBlur[1] ||
        ...
        searchResults.result === emptySearchResponse)
    ) {
      setInputText('');
      ...
      <div className={classes.flexColumn}>
        ...
        <ThemeProvider theme={lightBluePinkDarkMuiTheme}>
          <TextField
            ...
            onFocus={() => {
              handleSearchBlur(0, false);
              setTimeout(() => handleSearchBlur(1, false), 200);
            }}
            InputLabelProps={{
              shrink: true,
            }}
                  ...
                  <div className={classes.flexColumn}>
                    ...
                    {searchResults.result.festivals.length > 5 && (
                      <Typography
                        color="secondary"
                        variant="subtitle1"
                        className={classes.negativeMarginTop}
                      >
                        ...
                      </Typography>
                    )}
          ...
          <div>
            ...
            {showSearchFieldSmallScreen && (
              <div className={classes.fullWidthAndReverse}>
                <Paper
                  className={clsx(
                    classes.fixedWidthAbsolute,
                    classes.searchBarMarginTop
                  )}
                  style={{
                    backgroundColor:
                      thememode === 'dark' ? blueGrey[800] : blueGrey[700],
                  }}
                >
