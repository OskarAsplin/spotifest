export const europeanRegions = ['Northern Europe', 'Eastern Europe', 'Central Europe', 'Southern Europe', 'British Isles'];
export const usRegions = ['US: West', 'US: Mid-West', 'US: South', 'US: North-East'];
