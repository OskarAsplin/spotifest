...
export const spotifyAccountSlice = createSlice({
  ...
  reducers: {
    ...
    setPlaylists: (state, action: PayloadAction<Playlist[]>) => {
      const sortedPlaylists = action.payload.sort(
...
export const { setUserInfo, setTopArtists, setPlaylists } =
  spotifyAccountSlice.actions;

export const selectUserInfo = (state: RootState) =>
  state.spotifyAccount.userInfo;
export const selectTopArtists = (state: RootState) =>
  state.spotifyAccount.topArtists;
export const selectPlaylists = (state: RootState) =>
  state.spotifyAccount.playlists;
export const selectTopArtistsLoaded = (state: RootState) =>
  state.spotifyAccount.topArtistsLoaded;
export const selectPlaylistsLoaded = (state: RootState) =>
  state.spotifyAccount.playlistsLoaded;
export const selectCountTopArtists = (state: RootState) =>
  state.spotifyAccount.countTopArtists;
