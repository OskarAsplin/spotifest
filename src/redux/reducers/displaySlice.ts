...
export const { setSiteInitialized, setDbIsOnline, setDbIsOffline, turnOnLoader, turnOffLoader, switchToDarkMode, switchToLightMode, setShowPlaylistModal } = displaySlice.actions;

export const selectSiteInitialized = (state: RootState) => state.display.siteInitialized;
...
export const selectShowPlaylistModal = (state: RootState) => state.display.showPlaylistModal;
