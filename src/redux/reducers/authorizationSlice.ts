...
export const { setLoggedIn, setLoggedOff, setAccessToken, setTokenExpiryDate } = authorizationSlice.actions;

export const selectLoggedIn = (state: RootState) => state.authorization.loggedIn;
