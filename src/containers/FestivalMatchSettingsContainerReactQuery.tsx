...
import { setShowPlaylistModal } from '../redux/reducers/displaySlice';
...
const FestivalMatchSettingsContainerReactQuery = () => {
...
export default FestivalMatchSettingsContainerReactQuery;
